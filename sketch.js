...
function preload() {
  ...
  "images/mar2.png","images/mar3.png","images/mar4.png","images/mar5.png",
  "images/mar6.png","images/mar7.png",
  );
...
function draw() {
  ...
  textSize(20);
  fill("green");
  text("Score: " + coinScore, 650, 60);
}

function generateBricks() {
  if (frameCount % 70 === 0) {
    var brick = createSprite(1200, 130, 50, 15);
...
function generateCoins() {
  if (frameCount % 80 === 0) {
    var coin = createSprite(1300, 120, 40, 15);
